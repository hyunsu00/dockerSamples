...
echo "push : docker.io/hyunsu00/installpro-centos:7"
{
    docker push hyunsu00/installpro-centos:7
...
echo "push : docker.io/hyunsu00/installpro-rockylinux:8"
{
    docker push hyunsu00/installpro-rockylinux:8
...
echo "push : docker.io/hyunsu00/installpro-ubuntu:22.04"
{
    docker push hyunsu00/installpro-ubuntu:22.04
