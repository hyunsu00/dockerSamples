...
echo "push : docker.io/hyunsu00/installer-centos:7"
{
    docker push hyunsu00/installer-centos:7
...
echo "push : docker.io/hyunsu00/installer-rockylinux:8"
{
    docker push hyunsu00/installer-rockylinux:8
...
echo "push : docker.io/hyunsu00/installer-ubuntu:22.04"
{
    docker push hyunsu00/installer-ubuntu:22.04
